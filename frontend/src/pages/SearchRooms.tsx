        ...
        {filteredRooms.map((room, index) => (
          ...
          >
            <div className="p-5 border-b border-slate-100 flex justify-between items-start">
              ...
              >
                <div
                  className={`w-2 h-2 rounded-full mr-1.5 ${room.status === 'available' ? 'bg-green-600' : 'bg-red-600'}`}
                />
            ...
            <div className="p-5 flex-1 bg-slate-50/50">
              ...
              <ul className="space-y-2">
                ...
                {room.equipment.length === 0 ? <li className="text-sm text-slate-400 italic">无特殊设备</li> : null}
              </ul>
            </div>
